...
roll again on 20s when using the affected
...
in Torg Eternity can affect more than one target
simply by using the Multi-Target option (page
125) unless they explicity say otherwise.
To cast disguise on three friends, for example,
the caster simply subtracts 2 for each additional
recipient (–4 in this case).
Failing a spell roll in this case means none of
the targets are affected. The caster then suffers
the usual backlash (2 Shock) no matter how many
he attempted to affect.
When Multi-Targeting or casting a spell that
affects multiple targets, it’s considered successful
as long as least one individual is affected and
counts as one spell for concentration no matter
how many targets are included.
Example: Rama Tut hurls a fireball at a
group of Nile Empire Shocktroops and
the insidious Wu Han. He misses Wu
Han, but hits the shocktroops. The spell is
successful so Rama Tut suffers no Shock
for backlash.
189 MAGIC
189
...
Range: Touch
Duration: 3 rounds
Sometimes spells go terribly wrong, as this wight casting the mage hands spell learns.
191
MAGIC
191
...
Range: 50 meters
Duration: Concentration
The converse of mage dark, mage light fills a fivemeter radius with bright, scintillating light. All
